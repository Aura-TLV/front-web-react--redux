  ...
  <div className="col mb-5">
      <div className="d-flex flex-column">
        ...
        <div>
            ...
            <div className="my-2"><a className="fw-bold toggle-button" href="#collapseText2" data-bs-toggle="collapse" aria-expanded="true" aria-controls="collapseText2">Скрыть<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-arrow-up-short fs-5">
