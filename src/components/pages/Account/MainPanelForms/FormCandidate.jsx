...
import { toggleWage, toggleWorkingHour, toggleDriver, toggleLunch, toggleLiving } from '../../../../redux/slices/candidateSlice';
...
const FormCandidate = () => {
    ...
    const { selectedWages, selectedWorkingHours, selectedDriver, selectedLunch, selectedLiving } = useSelector(state => state.candidate);
    const { t } = useTranslation();

    // Состояние для файла резюме
                        ...
                        <div className="row d-flex flex-column flex-lg-row">
                            ...
                            <div className="col-lg-4 d-flex flex-column mb-4">
                                ...
                                <span className="fw-semibold d-lg-none d-xl-block">
                                    <a id="password" href="#" onClick={(e) => passwordLinkHandler(e, t('mainPanel.candidate.passwordResetSent'))} className="form-link">
                                    ...
                                    <div className="d-flex">
                                        {['8', '10', '12'].map(hour => (
                                            <span
                                                ...
                                                onClick={() => dispatch(toggleWorkingHour(hour))}
                                    ...
                                    <div className="d-flex">
                                        {['33+', '40', '50'].map(wage => (
                                            <span
                                                ...
                                                onClick={() => dispatch(toggleWage(wage))}
                                                style={{ cursor: 'pointer' }}
                                            >
                                                {wage}
                                            </span>
                                    ...
                                    <div className="d-flex">
                                        {[t('mainPanel.candidate.controls.checkboxY'), t('mainPanel.candidate.controls.checkboxN')].map(driver => (
                                            <span
                                                ...
                                                onClick={() => dispatch(toggleDriver(driver))}
                                                style={{ cursor: 'pointer' }}
                                            >
                                                {driver}
                                            </span>
                                    ...
                                    <div className="d-flex">
                                        {[t('mainPanel.candidate.controls.checkboxY'), t('mainPanel.candidate.controls.checkboxN')].map(lunch => (
                                            <span
                                                ...
                                                onClick={() => dispatch(toggleLunch(lunch))}
                                                style={{ cursor: 'pointer' }}
                                            >
                                                {lunch}
                                            </span>
                                    ...
                                    <div className="d-flex">
                                        {[t('mainPanel.candidate.controls.checkboxY'), t('mainPanel.candidate.controls.checkboxN')].map(living => (
                                            <span
                                                ...
                                                onClick={() => dispatch(toggleLiving(living))}
                                                style={{ cursor: 'pointer' }}
                                            >
                                                {living}
                                            </span>
