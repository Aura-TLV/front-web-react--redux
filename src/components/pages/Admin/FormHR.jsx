...
//import '../../../assets/js/toggle-hidden.js';
...
const FormHR = ({ setDetailsShown }) => {
  ...
  {t('mainPanel.returnToTable')}
                      ...
                      <form>
                          <div className="row d-flex flex-column flex-lg-row">
                              ...
                              <div className="col-lg-4 d-flex flex-column mb-4"><label className="form-label fw-bold">{t('mainPanel.company.password')}:</label>
                                  <div className="d-flex align-items-center position-relative">
                                    <img className="img-fluid position-absolute" src={iconEdit} style={isRtl ? {left: '10px'} : {right: '10px'}} />
                                    <input className="form-control border rounded-pill" type="text" placeholder="*******24" />
                                  </div>
                              </div>
                              <div className="col-lg-4 mb-4"><label className="form-label fw-bold">{t('mainPanel.company.name')}:</label>
                                  <div className="d-flex align-items-center position-relative">
                                    <img className="img-fluid position-absolute" src={iconEdit} style={isRtl ? {left: '10px'} : {right: '10px'}} />
                              ...
                              <div className="col-lg-12 col-xl-4 mb-4"><label className="form-label fw-bold">{t('mainPanel.company.companyType')}?</label>
                              <select className="border rounded-pill form-select text-muted">
                                      <optgroup>
                                          <option value="12" selected="">{t('companyAccount.typeBusiness.01')} </option>
                              ...
                              <div className="col-lg-4 d-flex flex-column mt-4">
                                  <div className="text-nowrap"><strong>{t('mainPanel.company.yourAds.label')}:</strong></div>
                              </div>
                              <div className="col-12">
                                  <div className="row additional-fields">
                                      ...
                                      <div className="col-lg-4 mb-4">
                                        ...
                                        <select className="form-select border rounded-pill text-muted">
                                              <optgroup>
                                                  <option value="12" selected="">{t('companyAccount.age.1')}</option>
  ...
  {selectedCity.map(city => (
    <input key={city} type="checkbox" name="city" value={city} checked readOnly hidden />
                                      ...
                                      <div className="col-12 mb-4 mt-5"><label className="form-label fw-semibold">{t('mainPanel.company.additionalInfo')}:</label>
